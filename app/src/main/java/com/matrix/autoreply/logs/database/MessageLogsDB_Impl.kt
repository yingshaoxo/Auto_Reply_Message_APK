...
import xyz.yingshaoxo.calling2email.logs.repository.AppPackageDao_Impl
import xyz.yingshaoxo.calling2email.logs.repository.MessageLogsDao
import xyz.yingshaoxo.calling2email.logs.repository.MessageLogsDao_Impl
import java.util.*
                ...
                override fun onValidateSchema(_db: SupportSQLiteDatabase): ValidationResult {
                    ...
                    if (_infoMessageLogs != _existingMessageLogs) {
                        return ValidationResult(
                            false, """message_logs(xyz.yingshaoxo.calling2email.logs.data.MessageLog).
 Expected:
$_infoMessageLogs
 Found:
$_existingMessageLogs"""
                    ...
                    return if (_infoAppPackages != _existingAppPackages) {
                        ValidationResult(
                            false, """app_packages(xyz.yingshaoxo.calling2email.logs.data.AppPackage).
 Expected:
$_infoAppPackages
 Found:
